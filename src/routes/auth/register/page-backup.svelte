    ...
    {#if currFormIndex === 0}
        ...
        >
            <div class="grid items-center">
                <a
                    class="btn-iconn btn text-surface-700 dark:text-surface-300 flex items-center justify-start gap-1 p-1 text-center"
                    href="/"
                    tabindex="0"
                >
                ...
                <div class="card grid w-[360px] justify-items-center p-10 shadow-lg">
                    <div class="text-center">
                        ...
                        <div class="grid grid-cols-[1fr_auto_1fr] items-center py-5">
                            <hr />
                            <p
                                class="text-surface-500 dark:text-surface-400 px-2 text-sm font-semibold uppercase"
                            >
                                or
                            </p>
                            <hr />
