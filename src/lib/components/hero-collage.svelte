...
<div class="hidden lg:grid grid-rows-2 grid-cols-2">
    ...
    >
        ...
        <div
            class="bg-blue-100 w-9 h-9 justify-self-center rounded-full row-start-1 col-start-1 z-0"
        />
    ...
    >
        ...
        />
        <div class="row-start-1 px-3 row-span-1 text-sm font-medium text-light-blue-800">
            Congrats!
        </div>
